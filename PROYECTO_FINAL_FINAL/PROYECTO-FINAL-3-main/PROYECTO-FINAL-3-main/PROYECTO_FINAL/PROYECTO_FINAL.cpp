...
void mostrarMenuChofer(Chofer& choferActual);

// Funciones para las opciones del menú
void iniciarSesion(Cliente& cliente, Chofer& chofer, string& username, string& password)
{
...
int main()
{
    ...
    int opcion;
    string username, password;  // Declarar las variables aquí
    ...
    do
    {
        ...
        {
        case 1:
            iniciarSesion(clienteActual, choferActual, username, password);  // Pasa las variables por referencia
            // Después del inicio de sesión, verifica si es un chofer y muestra el menú correspondiente
            if (clienteActual.verificarLogin(username, password)) {
                mostrarMenuCliente(clienteActual);
            }
            else if (choferActual.verificarLogin(username, password)) {
                mostrarMenuChofer(choferActual);
            }
            break;
        case 2:
            ...
            break;
        case 3:
            choferActual = registrarChofer();
            break;
        case 4:
            cout << "Gracias por usar la aplicacion. ¡Hasta luego!" << endl;
            break;
        default:
...
void mostrarMenuChofer(Chofer& choferActual) {
    ...
    do {
        cout << "\nMenú del Chofer:" << endl;
        cout << "1. Ver información del chofer" << endl;
        cout << "2. Modificar datos de la cuenta" << endl;
        cout << "3. Eliminar la cuenta" << endl;
        cout << "4. Volver al menú principal" << endl;
        ...
        switch (opcion) {
        case 1:
            cout << "1. Ver información del chofer";
            break;
        case 2:
            cout << "1. Ver información del chofer";
            break;
